...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4 relative">
    ...
    <!-- Register Container -->
    <div class="glass-effect rounded-2xl p-8 w-full max-w-md register-animation relative z-10">
        <!-- Back Button -->
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-white/80 text-sm">Bergabunglah dengan kami dan nikmati semua fitur</p>
        </div>
        ...
        <form id="registerForm" class="space-y-5">
            <!-- Name Input -->
            <div>
                <label for="fullName" class="block text-sm font-medium text-white/90 mb-2">Nama Lengkap</label>
                <input 
                    type="text" 
                    id="fullName" 
                    name="fullName" 
                ...
                >
                <div id="nameError" class="text-red-300 text-xs mt-1 hidden">Nama harus minimal 2 karakter</div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <div class="bg-white/20 rounded-full h-1">
                        <div id="passwordStrength" class="password-strength bg-white/40 rounded-full"></div>
                    </div>
            ...
            <div>
                <label for="confirmPassword" class="block text-sm font-medium text-white/90 mb-2">Konfirmasi Kata Sandi</label>
                <input 
                    type="password" 
                    id="confirmPassword" 
                ...
                >
                <div id="confirmError" class="text-red-300 text-xs mt-1 hidden">Kata sandi tidak cocok</div>
            </div>

            <!-- Terms Agreement -->
            <div class="flex items-start space-x-3">
                <input type="checkbox" id="agreeTerms" required class="w-4 h-4 text-indigo-600 bg-white/20 border-white/30 rounded focus:ring-white/50 mt-1 flex-shrink-0">
                <label for="agreeTerms" class="text-sm text-white/80 leading-relaxed">
                    Saya menyetujui <a href="#" class="text-white hover:underline font-medium">Syarat & Ketentuan</a> dan <a href="#" class="text-white hover:underline font-medium">Kebijakan Privasi</a> yang berlaku
                </label>
            </div>

            <!-- Newsletter Subscription -->
            <div class="flex items-start space-x-3">
                <input type="checkbox" id="newsletter" class="w-4 h-4 text-indigo-600 bg-white/20 border-white/30 rounded focus:ring-white/50 mt-1 flex-shrink-0">
        ...
        <div class="text-center mt-6">
            <p class="text-white/80 text-sm">
                Sudah punya akun? 
                <a href="login.html" class="text-white font-medium hover:underline">Masuk di sini</a>
            </p>
        </div>
    </div>
    ...
    <script>
        ...
        const strengthRequirement = document.getElementById('strengthRequirement');
        ...
        function checkPasswordStrength(password) {
            ...
            // Update UI
            passwordStrength.className = 'password-strength rounded-full transition-all duration-300';
            ...
            strengthRequirement.textContent = requirements.length > 0 ? requirements[0] : 'Memenuhi syarat';
        }
        ...
        registerForm.addEventListener('submit', function(e) {
            ...
            if (isNameValid && isEmailValid && isPasswordValid && isConfirmValid && isTermsAgreed) {
                // Show loading state
                ...
                setTimeout(() => {
                    ...
                    // Reset form
                    registerForm.reset();
                    passwordStrength.className = 'password-strength bg-white/40 rounded-full';
